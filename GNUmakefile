...
#
SUBDIRS := LArSoftImport #EventFilters CCInclusive #LArSoftImport NuEnergyStuff ERToolStuff SoftwareTrigger RecoEmulator DavidAnalysis #ADD_NEW_SUBDIR ... do not remove this comment from this line
#SignalSelection
#UBSensInterface
#CutStudy
#TrackStudy
