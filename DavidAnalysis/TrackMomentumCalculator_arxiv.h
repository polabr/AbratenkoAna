/**
 * \file TrackMomentumCalculator_arxiv.h
 *
 * \ingroup LArSoftImport
 *
 * \brief  TrackMomentumCalculator_arxiv.h
...
/** \addtogroup LArSoftImport
    ...
    @{*/
#ifndef TRACKMOMENTUMCALCULATOR_ARXIV_H
#define TRACKMOMENTUMCALCULATOR_ARXIV_H
...
/**
   \class TrackMomentumCalculator_arxiv
   User defined class TrackMomentumCalculator_arxiv ... these comments are used to generate
...
namespace larlite {
    ...
    public:
        ...
        TrackMomentumCalculator_arxiv();

        virtual ~TrackMomentumCalculator_arxiv() {};
