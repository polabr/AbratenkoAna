...
my_proc.set_ana_output_file("TrackEnergyPlots_OneHighEMTrackFilter_ana_out.root")
...
myfilter = fmwk.OnlyOneHighEMCTrackFilter()
myfilter.SetTrackCutoffEnergyMEV(25)
